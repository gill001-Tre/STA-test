...
const SubTasks = () => {
  ...
  const subTasks = selectedFilter === 'All' 
    ? allSubTasks 
    : allSubTasks.filter(task => task.keyActivity === keyActivityMap[selectedFilter])
        ...
        <div className="mb-8">
          <div className="flex justify-between items-start mb-2">
            ...
            <div className="flex items-center gap-4">
              <button
                onClick={() => navigate('/sub-tasks/progress')}
              ...
              >
                <option value="All">All Key Activities</option>
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-8 ml-8">
                  ...
                  {/* Edit Icon */}
                  <button
                    onClick={() => navigate(`/sub-tasks/update?id=${subTask.id}`)}
